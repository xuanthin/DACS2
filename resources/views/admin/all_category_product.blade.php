        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc chắn muốn xoá danh mục này không?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
